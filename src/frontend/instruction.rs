...
/// RVV (RISC-V Vector Extension) instruction enum
/// Note: Vector instructions use vd (vector destination) and vs1/vs2 (vector source)
/// which are encoded in the same fields as integer rd, rs1, rs2
#[derive(Debug, Copy, Clone, Eq, PartialEq)]
#[allow(non_camel_case_types)]
pub enum RVV {
    ...
    VSE256_V(Rs3, Rs1, VM),
    VSE512_V(Rs3, Rs1, VM),
    VSE1024_V(Rs3, Rs1, VM),

    // Vector load/store strided
    VLSE8_V(Rd, Rs1, Rs2, VM),
    VLSE16_V(Rd, Rs1, Rs2, VM),
    VLSE32_V(Rd, Rs1, Rs2, VM),
    VLSE64_V(Rd, Rs1, Rs2, VM),
    VLSE128_V(Rd, Rs1, Rs2, VM),
    VLSE256_V(Rd, Rs1, Rs2, VM),
    VLSE512_V(Rd, Rs1, Rs2, VM),
    VLSE1024_V(Rd, Rs1, Rs2, VM),

    VSSE8_V(Rs3, Rs1, Rs2, VM),
    VSSE16_V(Rs3, Rs1, Rs2, VM),
    VSSE32_V(Rs3, Rs1, Rs2, VM),
    VSSE64_V(Rs3, Rs1, Rs2, VM),
    VSSE128_V(Rs3, Rs1, Rs2, VM),
    VSSE256_V(Rs3, Rs1, Rs2, VM),
    VSSE512_V(Rs3, Rs1, Rs2, VM),
    VSSE1024_V(Rs3, Rs1, Rs2, VM),

    // Vector load/store indexed (unordered)
    VLUXEI8_V(Rd, Rs1, Rs2, VM),
    VLUXEI16_V(Rd, Rs1, Rs2, VM),
    VLUXEI32_V(Rd, Rs1, Rs2, VM),
    VLUXEI64_V(Rd, Rs1, Rs2, VM),
    VLUXEI128_V(Rd, Rs1, Rs2, VM),
    VLUXEI256_V(Rd, Rs1, Rs2, VM),
    VLUXEI512_V(Rd, Rs1, Rs2, VM),
    VLUXEI1024_V(Rd, Rs1, Rs2, VM),

    VSUXEI8_V(Rs3, Rs1, Rs2, VM),
    VSUXEI16_V(Rs3, Rs1, Rs2, VM),
    VSUXEI32_V(Rs3, Rs1, Rs2, VM),
    VSUXEI64_V(Rs3, Rs1, Rs2, VM),
    VSUXEI128_V(Rs3, Rs1, Rs2, VM),
    VSUXEI256_V(Rs3, Rs1, Rs2, VM),
    VSUXEI512_V(Rs3, Rs1, Rs2, VM),
    VSUXEI1024_V(Rs3, Rs1, Rs2, VM),

    // Vector load/store indexed (ordered)
    VLOXEI8_V(Rd, Rs1, Rs2, VM),
    VLOXEI16_V(Rd, Rs1, Rs2, VM),
    VLOXEI32_V(Rd, Rs1, Rs2, VM),
    VLOXEI64_V(Rd, Rs1, Rs2, VM),
    VLOXEI128_V(Rd, Rs1, Rs2, VM),
    VLOXEI256_V(Rd, Rs1, Rs2, VM),
    VLOXEI512_V(Rd, Rs1, Rs2, VM),
    VLOXEI1024_V(Rd, Rs1, Rs2, VM),

    VSOXEI8_V(Rs3, Rs1, Rs2, VM),
    VSOXEI16_V(Rs3, Rs1, Rs2, VM),
    VSOXEI32_V(Rs3, Rs1, Rs2, VM),
    VSOXEI64_V(Rs3, Rs1, Rs2, VM),
    VSOXEI128_V(Rs3, Rs1, Rs2, VM),
    VSOXEI256_V(Rs3, Rs1, Rs2, VM),
    VSOXEI512_V(Rs3, Rs1, Rs2, VM),
    VSOXEI1024_V(Rs3, Rs1, Rs2, VM),
    ...
    // Vector integer arithmetic - VV format (vector-vector)
    VADD_VV(Rd, Rs1, Rs2, VM),
    VSUB_VV(Rd, Rs1, Rs2, VM),
    VMINU_VV(Rd, Rs1, Rs2, VM),
    VMIN_VV(Rd, Rs1, Rs2, VM),
    VMAXU_VV(Rd, Rs1, Rs2, VM),
    VMAX_VV(Rd, Rs1, Rs2, VM),
    VAND_VV(Rd, Rs1, Rs2, VM),
    VOR_VV(Rd, Rs1, Rs2, VM),
    VXOR_VV(Rd, Rs1, Rs2, VM),
    VSLL_VV(Rd, Rs1, Rs2, VM),
    VSRL_VV(Rd, Rs1, Rs2, VM),
    VSRA_VV(Rd, Rs1, Rs2, VM),
    VSADDU_VV(Rd, Rs1, Rs2, VM),
    VSADD_VV(Rd, Rs1, Rs2, VM),
    VSSUBU_VV(Rd, Rs1, Rs2, VM),
    VSSUB_VV(Rd, Rs1, Rs2, VM),
    VSSRL_VV(Rd, Rs1, Rs2, VM),
    VSSRA_VV(Rd, Rs1, Rs2, VM),
    VSMUL_VV(Rd, Rs1, Rs2, VM),

    // Vector integer arithmetic - VX format (vector-scalar)
    VADD_VX(Rd, Rs1, Rs2, VM),
    VSUB_VX(Rd, Rs1, Rs2, VM),
    VRSUB_VX(Rd, Rs1, Rs2, VM),
    VMINU_VX(Rd, Rs1, Rs2, VM),
    VMIN_VX(Rd, Rs1, Rs2, VM),
    VMAXU_VX(Rd, Rs1, Rs2, VM),
    VMAX_VX(Rd, Rs1, Rs2, VM),
    VAND_VX(Rd, Rs1, Rs2, VM),
    VOR_VX(Rd, Rs1, Rs2, VM),
    VXOR_VX(Rd, Rs1, Rs2, VM),
    VSLL_VX(Rd, Rs1, Rs2, VM),
    VSRL_VX(Rd, Rs1, Rs2, VM),
    VSRA_VX(Rd, Rs1, Rs2, VM),
    VSADDU_VX(Rd, Rs1, Rs2, VM),
    VSADD_VX(Rd, Rs1, Rs2, VM),
    VSSUBU_VX(Rd, Rs1, Rs2, VM),
    VSSUB_VX(Rd, Rs1, Rs2, VM),
    VSSRL_VX(Rd, Rs1, Rs2, VM),
    VSSRA_VX(Rd, Rs1, Rs2, VM),
    VSMUL_VX(Rd, Rs1, Rs2, VM),

    // Vector integer arithmetic - VI format (vector-immediate)
    VADD_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VRSUB_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VAND_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VOR_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VXOR_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSLL_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSRL_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSRA_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSADDU_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSADD_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSSRL_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSSRA_VI(Rd, Rs2, Imm32<19, 15>, VM),

    // Vector comparison
    VMSEQ_VV(Rd, Rs1, Rs2, VM),
    VMSEQ_VX(Rd, Rs1, Rs2, VM),
    VMSEQ_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VMSNE_VV(Rd, Rs1, Rs2, VM),
    VMSNE_VX(Rd, Rs1, Rs2, VM),
    VMSNE_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VMSLTU_VV(Rd, Rs1, Rs2, VM),
    VMSLTU_VX(Rd, Rs1, Rs2, VM),
    VMSLT_VV(Rd, Rs1, Rs2, VM),
    VMSLT_VX(Rd, Rs1, Rs2, VM),
    VMSLEU_VV(Rd, Rs1, Rs2, VM),
    VMSLEU_VX(Rd, Rs1, Rs2, VM),
    VMSLEU_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VMSLE_VV(Rd, Rs1, Rs2, VM),
    VMSLE_VX(Rd, Rs1, Rs2, VM),
    VMSLE_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VMSGTU_VX(Rd, Rs1, Rs2, VM),
    VMSGTU_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VMSGT_VX(Rd, Rs1, Rs2, VM),
    VMSGT_VI(Rd, Rs2, Imm32<19, 15>, VM),

    // Vector multiply/divide
    VMUL_VV(Rd, Rs1, Rs2, VM),
    VMUL_VX(Rd, Rs1, Rs2, VM),
    VMULH_VV(Rd, Rs1, Rs2, VM),
    VMULH_VX(Rd, Rs1, Rs2, VM),
    VMULHU_VV(Rd, Rs1, Rs2, VM),
    VMULHU_VX(Rd, Rs1, Rs2, VM),
    VMULHSU_VV(Rd, Rs1, Rs2, VM),
    VMULHSU_VX(Rd, Rs1, Rs2, VM),
    VDIVU_VV(Rd, Rs1, Rs2, VM),
    VDIVU_VX(Rd, Rs1, Rs2, VM),
    VDIV_VV(Rd, Rs1, Rs2, VM),
    VDIV_VX(Rd, Rs1, Rs2, VM),
    VREMU_VV(Rd, Rs1, Rs2, VM),
    VREMU_VX(Rd, Rs1, Rs2, VM),
    VREM_VV(Rd, Rs1, Rs2, VM),
    VREM_VX(Rd, Rs1, Rs2, VM),

    // Vector widening arithmetic
    VWADDU_VV(Rd, Rs1, Rs2, VM),
    VWADDU_VX(Rd, Rs1, Rs2, VM),
    VWSUBU_VV(Rd, Rs1, Rs2, VM),
    VWSUBU_VX(Rd, Rs1, Rs2, VM),
    VWADD_VV(Rd, Rs1, Rs2, VM),
    VWADD_VX(Rd, Rs1, Rs2, VM),
    VWSUB_VV(Rd, Rs1, Rs2, VM),
    VWSUB_VX(Rd, Rs1, Rs2, VM),
    VWADDU_WV(Rd, Rs1, Rs2, VM),
    VWADDU_WX(Rd, Rs1, Rs2, VM),
    VWSUBU_WV(Rd, Rs1, Rs2, VM),
    VWSUBU_WX(Rd, Rs1, Rs2, VM),
    VWADD_WV(Rd, Rs1, Rs2, VM),
    VWADD_WX(Rd, Rs1, Rs2, VM),
    VWSUB_WV(Rd, Rs1, Rs2, VM),
    VWSUB_WX(Rd, Rs1, Rs2, VM),
    VWMULU_VV(Rd, Rs1, Rs2, VM),
    VWMULU_VX(Rd, Rs1, Rs2, VM),
    VWMULSU_VV(Rd, Rs1, Rs2, VM),
    VWMULSU_VX(Rd, Rs1, Rs2, VM),
    VWMUL_VV(Rd, Rs1, Rs2, VM),
    VWMUL_VX(Rd, Rs1, Rs2, VM),

    // Vector narrowing arithmetic
    VNSRL_WV(Rd, Rs1, Rs2, VM),
    VNSRL_WX(Rd, Rs1, Rs2, VM),
    VNSRL_WI(Rd, Rs2, Imm32<19, 15>, VM),
    VNSRA_WV(Rd, Rs1, Rs2, VM),
    VNSRA_WX(Rd, Rs1, Rs2, VM),
    VNSRA_WI(Rd, Rs2, Imm32<19, 15>, VM),
    VNCLIPU_WV(Rd, Rs1, Rs2, VM),
    VNCLIPU_WX(Rd, Rs1, Rs2, VM),
    VNCLIPU_WI(Rd, Rs2, Imm32<19, 15>, VM),
    VNCLIP_WV(Rd, Rs1, Rs2, VM),
    VNCLIP_WX(Rd, Rs1, Rs2, VM),
    VNCLIP_WI(Rd, Rs2, Imm32<19, 15>, VM),
    ...
    VADC_VVM(Rd, Rs1, Rs2),
    VADC_VXM(Rd, Rs1, Rs2),
    VADC_VIM(Rd, Rs2, Imm32<19, 15>),
    VMADC_VV(Rd, Rs1, Rs2),
    VMADC_VX(Rd, Rs1, Rs2),
    VMADC_VI(Rd, Rs2, Imm32<19, 15>),
    VMADC_VVM(Rd, Rs1, Rs2, VM),
    VMADC_VXM(Rd, Rs1, Rs2, VM),
    VMADC_VIM(Rd, Rs2, Imm32<19, 15>, VM),
    VSBC_VVM(Rd, Rs1, Rs2),
    VSBC_VXM(Rd, Rs1, Rs2),
    VMSBC_VV(Rd, Rs1, Rs2),
    VMSBC_VX(Rd, Rs1, Rs2),
    VMSBC_VVM(Rd, Rs1, Rs2, VM),
    VMSBC_VXM(Rd, Rs1, Rs2, VM),

    // Vector merge/move
    VMERGE_VVM(Rd, Rs1, Rs2),
    VMERGE_VXM(Rd, Rs1, Rs2),
    VMERGE_VIM(Rd, Rs2, Imm32<19, 15>),
    VMV_V_V(Rd, Rs1),
    VMV_V_X(Rd, Rs1),
    VMV_V_I(Rd, Imm32<19, 15>),
    VMV_X_S(Rd, Rs2),
    VMV_S_X(Rd, Rs1),
    VMV1R_V(Rd, Rs1),
    VMV2R_V(Rd, Rs1),
    ...
    // Vector averaging instructions
    VAADDU_VV(Rd, Rs1, Rs2, VM),
    VAADDU_VX(Rd, Rs1, Rs2, VM),
    VAADD_VV(Rd, Rs1, Rs2, VM),
    VAADD_VX(Rd, Rs1, Rs2, VM),
    VASUBU_VV(Rd, Rs1, Rs2, VM),
    VASUBU_VX(Rd, Rs1, Rs2, VM),
    VASUB_VV(Rd, Rs1, Rs2, VM),
    VASUB_VX(Rd, Rs1, Rs2, VM),

    // Vector mask instructions
    VMAND_MM(Rd, Rs1, Rs2),
    VMNAND_MM(Rd, Rs1, Rs2),
    VMANDNOT_MM(Rd, Rs1, Rs2),
    VMXOR_MM(Rd, Rs1, Rs2),
    VMOR_MM(Rd, Rs1, Rs2),
    VMNOR_MM(Rd, Rs1, Rs2),
    VMORNOT_MM(Rd, Rs1, Rs2),
    VMXNOR_MM(Rd, Rs1, Rs2),
    VCPOP_M(Rd, Rs2, VM),
    VFIRST_M(Rd, Rs2, VM),
    VMSBF_M(Rd, Rs2, VM),
    VMSOF_M(Rd, Rs2, VM),
    ...
    // Vector multiply-add
    VMACC_VV(Rd, Rs1, Rs2, VM),
    VMACC_VX(Rd, Rs1, Rs2, VM),
    VNMSAC_VV(Rd, Rs1, Rs2, VM),
    VNMSAC_VX(Rd, Rs1, Rs2, VM),
    VMADD_VV(Rd, Rs1, Rs2, VM),
    VMADD_VX(Rd, Rs1, Rs2, VM),
    VNMSUB_VV(Rd, Rs1, Rs2, VM),
    VNMSUB_VX(Rd, Rs1, Rs2, VM),
    VWMACCU_VV(Rd, Rs1, Rs2, VM),
    VWMACCU_VX(Rd, Rs1, Rs2, VM),
    VWMACC_VV(Rd, Rs1, Rs2, VM),
    VWMACC_VX(Rd, Rs1, Rs2, VM),
    VWMACCSU_VV(Rd, Rs1, Rs2, VM),
    VWMACCSU_VX(Rd, Rs1, Rs2, VM),
    VWMACCUS_VX(Rd, Rs1, Rs2, VM),

    // Vector reduction
    VREDSUM_VS(Rd, Rs1, Rs2, VM),
    VREDAND_VS(Rd, Rs1, Rs2, VM),
    VREDOR_VS(Rd, Rs1, Rs2, VM),
    VREDXOR_VS(Rd, Rs1, Rs2, VM),
    VREDMINU_VS(Rd, Rs1, Rs2, VM),
    VREDMIN_VS(Rd, Rs1, Rs2, VM),
    VREDMAXU_VS(Rd, Rs1, Rs2, VM),
    VREDMAX_VS(Rd, Rs1, Rs2, VM),
    VWREDSUMU_VS(Rd, Rs1, Rs2, VM),
    VWREDSUM_VS(Rd, Rs1, Rs2, VM),

    // Vector permutation
    VSLIDEUP_VX(Rd, Rs1, Rs2, VM),
    VSLIDEUP_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSLIDEDOWN_VX(Rd, Rs1, Rs2, VM),
    VSLIDEDOWN_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VSLIDE1UP_VX(Rd, Rs1, Rs2, VM),
    VSLIDE1DOWN_VX(Rd, Rs1, Rs2, VM),
    VRGATHER_VV(Rd, Rs1, Rs2, VM),
    VRGATHER_VX(Rd, Rs1, Rs2, VM),
    VRGATHER_VI(Rd, Rs2, Imm32<19, 15>, VM),
    VRGATHEREI16_VV(Rd, Rs1, Rs2, VM),
    VCOMPRESS_VM(Rd, Rs1, Rs2),
}
...
/// Vector mask bit (bit 25)
#[inline(always)]
pub fn vm(bit: u32) -> bool {
    slice(bit, 25, 1, 0) != 0
}

/// funct6 field for vector instructions (bits [31:26])
#[inline(always)]
pub fn funct6(bit: u32) -> u32 {
    slice(bit, 26, 6, 0)
}

/// Utility module for bit extraction (used in commented vector code)
pub mod utils {
    use super::slice;

    /// Extract bits from instruction - alias for slice function
    #[inline(always)]
    pub fn x(bit: u32, lo: usize, len: usize, s: usize) -> u32 {
        slice(bit, lo, len, s)
    }
}
                ...
                //     }
                    0b111 => {
                        ...
                        match bit_u32 {
                            ...
                            x if x & 0b10000000000000000111000001111111 == 0b00000000000000000111000001010111 => Some(rv64_no_e!(
                                RV64V,
                                VSETVLI,
                            ...
                            x if x & 0b11000000000000000111000001111111 == 0b11000000000000000111000001010111 => Some(rv64_no_e!(
                                RV64V,
                                VSETIVLI,
                                Rd(Reg::V(Xx::new(rd(bit_u32)))),
                            ...
                            // VSETVL: vd, rs1, rs2
                            x if x & 0b11111110000000000111000001111111 == 0b10000000000000000111000001010111 => Some(rv64_no_e!(
                                RV64V,
                                VSETVL,
                                Rd(Reg::V(Xx::new(rd(bit_u32)))),
                                Rs1(Reg::X(Xx::new(rs1(bit_u32)))),
